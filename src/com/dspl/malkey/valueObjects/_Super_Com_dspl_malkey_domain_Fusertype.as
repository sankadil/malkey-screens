 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fusertype.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fusertype extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fusertype") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fusertype", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FusertypeEntityMetadata;
    ...
    public function _Super_Com_dspl_malkey_domain_Fusertype()
    {
        _model = new _Com_dspl_malkey_domain_FusertypeEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FusertypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FusertypeEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FusertypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
