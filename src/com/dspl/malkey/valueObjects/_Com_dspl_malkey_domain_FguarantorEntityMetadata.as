...
[ExcludeClass]
internal class _Com_dspl_malkey_domain_FguarantorEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("homeadd2", "homeadd3", "adddate", "gname", "mobilephone", "approved", "offadd2", "offadd3", "nicno", "offtele", "homeadd1", "nicimage", "debcode", "addmach", "passportno", "adduser", "nicbackimage", "nicbackimagedata", "ppimage", "offadd1", "company", "gid", "nicimagedata", "recordid", "passimagedata", "hometele");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("homeadd2", "homeadd3", "adddate", "gname", "mobilephone", "approved", "offadd2", "offadd3", "nicno", "offtele", "homeadd1", "nicimage", "debcode", "addmach", "passportno", "adduser", "nicbackimage", "nicbackimagedata", "ppimage", "offadd1", "company", "gid", "nicimagedata", "recordid", "passimagedata", "hometele");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("homeadd2", "homeadd3", "adddate", "gname", "mobilephone", "approved", "offadd2", "offadd3", "nicno", "offtele", "homeadd1", "nicimage", "debcode", "addmach", "passportno", "adduser", "nicbackimage", "nicbackimagedata", "ppimage", "offadd1", "company", "gid", "nicimagedata", "recordid", "passimagedata", "hometele");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Com_dspl_malkey_domain_Fguarantor";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();


    model_internal var _instance:_Super_Com_dspl_malkey_domain_Fguarantor;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Com_dspl_malkey_domain_FguarantorEntityMetadata(value : _Super_Com_dspl_malkey_domain_Fguarantor)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["offadd2"] = new Array();
            model_internal::dependentsOnMap["offadd3"] = new Array();
            model_internal::dependentsOnMap["nicno"] = new Array();
            model_internal::dependentsOnMap["offtele"] = new Array();
            ...
            model_internal::dependentsOnMap["offadd1"] = new Array();
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Com_dspl_malkey_domain_Fguarantor");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Com_dspl_malkey_domain_Fguarantor");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Com_dspl_malkey_domain_Fguarantor");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isOffadd2Available():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isOffadd3Available():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isOffteleAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isOffadd1Available():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get offadd2Style():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    [Bindable(event="propertyChange")]   
    public function get offadd3Style():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get offteleStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get offadd1Style():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
