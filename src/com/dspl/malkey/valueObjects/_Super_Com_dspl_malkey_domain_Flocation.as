 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Flocation.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Flocation extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Flocation") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Flocation", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FlocationEntityMetadata;

    /**
     * properties
     */
    private var _internal_checkinloc : String;
    ...
    public function _Super_Com_dspl_malkey_domain_Flocation()
    {
        _model = new _Com_dspl_malkey_domain_FlocationEntityMetadata(this);
    ...
    public function get checkinloc() : String
    {
        return _internal_checkinloc;
    }
    ...
    public function set checkinloc(value:String) : void
    {
        var oldValue:String = _internal_checkinloc;
        if (oldValue !== value)
        {
            _internal_checkinloc = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "checkinloc", oldValue, _internal_checkinloc));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FlocationEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FlocationEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FlocationEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
