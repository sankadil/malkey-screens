 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_view_HireDetailsView.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_view_HireDetailsView extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.view.HireDetailsView") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.view.HireDetailsView", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_view_HireDetailsViewEntityMetadata;
    ...
    public function _Super_Com_dspl_malkey_view_HireDetailsView()
    {
        _model = new _Com_dspl_malkey_view_HireDetailsViewEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_view_HireDetailsViewEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_view_HireDetailsViewEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_view_HireDetailsViewEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
