 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fresothersrvrate.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fresothersrvrate extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fresothersrvrate") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fresothersrvrate", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FresothersrvrateEntityMetadata;

    /**
     * properties
     */
    private var _internal_id : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresothersrvratePK;
    ...
    public function _Super_Com_dspl_malkey_domain_Fresothersrvrate()
    {
        _model = new _Com_dspl_malkey_domain_FresothersrvrateEntityMetadata(this);
    ...
    public function get id() : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresothersrvratePK
    {
        return _internal_id;
    }
    ...
    public function set id(value:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresothersrvratePK) : void
    {
        var oldValue:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresothersrvratePK = _internal_id;
        if (oldValue !== value)
        {
            _internal_id = value;
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FresothersrvrateEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FresothersrvrateEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FresothersrvrateEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfId : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresothersrvratePK;

    model_internal function _doValidationForId(valueIn:Object):Array
    {
        var value : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresothersrvratePK = valueIn as com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresothersrvratePK;
