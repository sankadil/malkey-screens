...
internal class _Com_dspl_malkey_domain_FdebtorEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("islongterm", "debstat", "vatno", "tel", "adddate", "vattyp", "debadd", "billmob1", "crlmt", "billmob2", "billname", "nicno", "officeadd", "homeadd", "svatno", "officemob", "longterm", "debname", "nicimage", "fax", "debcode", "curcode", "addmach", "nicbackimage", "adduser", "passportno", "debemail", "nicbackimagedata", "debacc", "ppimage", "debfax", "country", "debtype", "emailClient", "clienttype", "email", "isSelected", "company", "crepre", "gid", "contper", "officetele", "homemob", "nicimagedata", "passimagedata", "recordid", "hometele");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("debstat", "vatno", "tel", "adddate", "vattyp", "debadd", "billmob1", "crlmt", "billmob2", "billname", "nicno", "officeadd", "homeadd", "officemob", "longterm", "debname", "nicimage", "fax", "debcode", "curcode", "addmach", "nicbackimage", "adduser", "passportno", "debemail", "nicbackimagedata", "debacc", "ppimage", "debfax", "country", "debtype", "emailClient", "clienttype", "email", "isSelected", "company", "crepre", "gid", "contper", "officetele", "homemob", "nicimagedata", "passimagedata", "recordid", "hometele");
