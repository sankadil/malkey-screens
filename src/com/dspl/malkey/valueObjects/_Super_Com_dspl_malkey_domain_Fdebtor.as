...
public class _Super_Com_dspl_malkey_domain_Fdebtor extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    public function _Super_Com_dspl_malkey_domain_Fdebtor()
    {
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "svatno", model_internal::setterListenerSvatno));
    ...
    model_internal function setterListenerSvatno(value:flash.events.Event):void
    {
        _model.invalidateDependentOnSvatno();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.svatnoIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_svatnoValidationFailureMessages);
        }
    ...
    model_internal var _doValidationCacheOfSvatno : Array = null;
    model_internal var _doValidationLastValOfSvatno : String;

    model_internal function _doValidationForSvatno(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfSvatno != null && model_internal::_doValidationLastValOfSvatno == value)
           return model_internal::_doValidationCacheOfSvatno ;

        _model.model_internal::_svatnoIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isSvatnoAvailable && _internal_svatno == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "svatno is required"));
        }

        model_internal::_doValidationCacheOfSvatno = validationFailures;
        model_internal::_doValidationLastValOfSvatno = value;
