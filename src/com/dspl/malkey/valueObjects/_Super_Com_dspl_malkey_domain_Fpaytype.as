 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fpaytype.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fpaytype extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fpaytype") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fpaytype", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FpaytypeEntityMetadata;
    ...
    public function _Super_Com_dspl_malkey_domain_Fpaytype()
    {
        _model = new _Com_dspl_malkey_domain_FpaytypeEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FpaytypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FpaytypeEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FpaytypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
