 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fvinventrylist.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fvinventrylist extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fvinventrylist") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fvinventrylist", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FvinventrylistEntityMetadata;

    /**
     * properties
     */
    private var _internal_invid : String;
    private var _internal_isselected : int;
    ...
    public function _Super_Com_dspl_malkey_domain_Fvinventrylist()
    {
        _model = new _Com_dspl_malkey_domain_FvinventrylistEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get isselected() : int
    {
    ...
    public function set isselected(value:int) : void
    {
        var oldValue:int = _internal_isselected;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FvinventrylistEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FvinventrylistEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FvinventrylistEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
