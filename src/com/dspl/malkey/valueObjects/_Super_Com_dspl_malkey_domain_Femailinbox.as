 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Femailinbox.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Femailinbox extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Femailinbox") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Femailinbox", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FemailinboxEntityMetadata;
    ...
    private var _internal_dreceived : Date;
    ...
    public function _Super_Com_dspl_malkey_domain_Femailinbox()
    {
        _model = new _Com_dspl_malkey_domain_FemailinboxEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get dreceived() : Date
    {
        return _internal_dreceived;
    }
    ...
    public function set dreceived(value:Date) : void
    {
        var oldValue:Date = _internal_dreceived;
        if (oldValue !== value)
        {
            _internal_dreceived = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "dreceived", oldValue, _internal_dreceived));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FemailinboxEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FemailinboxEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FemailinboxEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
