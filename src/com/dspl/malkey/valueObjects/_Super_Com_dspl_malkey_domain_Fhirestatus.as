 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fhirestatus.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fhirestatus extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fhirestatus") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fhirestatus", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FhirestatusEntityMetadata;
    ...
    private var _internal_hirestsid : String;
    ...
    public function _Super_Com_dspl_malkey_domain_Fhirestatus()
    {
        _model = new _Com_dspl_malkey_domain_FhirestatusEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get hirestsid() : String
    {
        return _internal_hirestsid;
    }
    ...
    public function set hirestsid(value:String) : void
    {
        var oldValue:String = _internal_hirestsid;
        if (oldValue !== value)
        {
            _internal_hirestsid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "hirestsid", oldValue, _internal_hirestsid));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FhirestatusEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FhirestatusEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FhirestatusEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
