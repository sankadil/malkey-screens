 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fvehicleclass.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fvehicleclass extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fvehicleclass") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fvehicleclass", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FvehicleclassEntityMetadata;
    ...
    public function _Super_Com_dspl_malkey_domain_Fvehicleclass()
    {
        _model = new _Com_dspl_malkey_domain_FvehicleclassEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FvehicleclassEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FvehicleclassEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FvehicleclassEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
