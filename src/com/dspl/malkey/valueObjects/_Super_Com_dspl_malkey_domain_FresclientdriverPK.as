 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_FresclientdriverPK.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_FresclientdriverPK extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.FresclientdriverPK") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.FresclientdriverPK", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FresclientdriverPKEntityMetadata;

    /**
     * properties
     */
    private var _internal_resno : String;
    private var _internal_driverid : int;
    ...
    public function _Super_Com_dspl_malkey_domain_FresclientdriverPK()
    {
        _model = new _Com_dspl_malkey_domain_FresclientdriverPKEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get driverid() : int
    {
    ...
    public function set driverid(value:int) : void
    {
        var oldValue:int = _internal_driverid;
        if (oldValue !== value)
        {
            _internal_driverid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "driverid", oldValue, _internal_driverid));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FresclientdriverPKEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FresclientdriverPKEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FresclientdriverPKEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
