...
[ExcludeClass]
internal class _Com_dspl_malkey_domain_FresothsrvEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("id", "noofdays", "ratetype", "rate", "description", "standardrate", "adduser", "remarks", "uuid", "fresothersrvrate", "recordid", "discount");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "noofdays", "ratetype", "rate", "description", "standardrate", "adduser", "remarks", "uuid", "fresothersrvrate", "recordid", "discount");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "noofdays", "ratetype", "rate", "description", "standardrate", "adduser", "remarks", "uuid", "fresothersrvrate", "recordid", "discount");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "noofdays", "ratetype", "rate", "description", "standardrate", "adduser", "remarks", "uuid", "fresothersrvrate", "recordid", "discount");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Com_dspl_malkey_domain_Fresothsrv";
    ...
    model_internal var _fresothersrvrateIsValid:Boolean;
    model_internal var _fresothersrvrateValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _fresothersrvrateIsValidCacheInitialized:Boolean = false;
    model_internal var _fresothersrvrateValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_Com_dspl_malkey_domain_Fresothsrv;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Com_dspl_malkey_domain_FresothsrvEntityMetadata(value : _Super_Com_dspl_malkey_domain_Fresothsrv)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["fresothersrvrate"] = new Array();
        ...
        model_internal::_fresothersrvrateValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForFresothersrvrate);
        model_internal::_fresothersrvrateValidator.required = true;
        model_internal::_fresothersrvrateValidator.requiredFieldError = "fresothersrvrate is required";
        //model_internal::_fresothersrvrateValidator.source = model_internal::_instance;
        //model_internal::_fresothersrvrateValidator.property = "fresothersrvrate";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Com_dspl_malkey_domain_Fresothsrv");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Com_dspl_malkey_domain_Fresothsrv");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Com_dspl_malkey_domain_Fresothsrv");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isFresothersrvrateAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnFresothersrvrate():void
    {
        if (model_internal::_fresothersrvrateIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfFresothersrvrate = null;
            model_internal::calculateFresothersrvrateIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get fresothersrvrateStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get fresothersrvrateValidator() : StyleValidator
    {
        return model_internal::_fresothersrvrateValidator;
    }

    model_internal function set _fresothersrvrateIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_fresothersrvrateIsValid;         
        if (oldValue !== value)
        {
            model_internal::_fresothersrvrateIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "fresothersrvrateIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get fresothersrvrateIsValid():Boolean
    {
        if (!model_internal::_fresothersrvrateIsValidCacheInitialized)
        {
            model_internal::calculateFresothersrvrateIsValid();
        ...
        return model_internal::_fresothersrvrateIsValid;
    }

    model_internal function calculateFresothersrvrateIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_fresothersrvrateValidator.validate(model_internal::_instance.fresothersrvrate)
        model_internal::_fresothersrvrateIsValid_der = (valRes.results == null);
        model_internal::_fresothersrvrateIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::fresothersrvrateValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::fresothersrvrateValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get fresothersrvrateValidationFailureMessages():Array
    {
        if (model_internal::_fresothersrvrateValidationFailureMessages == null)
            model_internal::calculateFresothersrvrateIsValid();

        return _fresothersrvrateValidationFailureMessages;
    }

    model_internal function set fresothersrvrateValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_fresothersrvrateValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_fresothersrvrateValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "fresothersrvrateValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("fresothersrvrate"):
            {
                return fresothersrvrateValidationFailureMessages;
            }
            case("discount"):
            {
