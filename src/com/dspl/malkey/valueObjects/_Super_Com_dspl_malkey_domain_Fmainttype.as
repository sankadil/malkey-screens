 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fmainttype.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fmainttype extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fmainttype") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fmainttype", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FmainttypeEntityMetadata;

    /**
     * properties
     */
    private var _internal_mileage : int;
    private var _internal_isdefault : int;
    ...
    public function _Super_Com_dspl_malkey_domain_Fmainttype()
    {
        _model = new _Com_dspl_malkey_domain_FmainttypeEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get isdefault() : int
    {
    ...
    public function set isdefault(value:int) : void
    {
        var oldValue:int = _internal_isdefault;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FmainttypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FmainttypeEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FmainttypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
