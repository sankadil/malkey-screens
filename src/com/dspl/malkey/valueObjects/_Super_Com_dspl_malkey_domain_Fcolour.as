 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fcolour.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fcolour extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fcolour") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fcolour", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FcolourEntityMetadata;

    /**
     * properties
     */
    private var _internal_colourid : String;
    private var _internal_colcode : int;
    ...
    public function _Super_Com_dspl_malkey_domain_Fcolour()
    {
        _model = new _Com_dspl_malkey_domain_FcolourEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get colcode() : int
    {
        return _internal_colcode;
    }
    ...
    public function set colcode(value:int) : void
    {
        var oldValue:int = _internal_colcode;
        if (oldValue !== value)
        {
            _internal_colcode = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "colcode", oldValue, _internal_colcode));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FcolourEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FcolourEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FcolourEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
