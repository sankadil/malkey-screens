 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fdriverrate.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fdriverrate extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fdriverrate") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fdriverrate", cz);
            }
        }
        catch (e:Error)
        {
    ...
    {
        com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FdriverratePK.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FdriverrateEntityMetadata;

    /**
     * properties
     */
    private var _internal_id : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FdriverratePK;
    ...
    public function _Super_Com_dspl_malkey_domain_Fdriverrate()
    {
        _model = new _Com_dspl_malkey_domain_FdriverrateEntityMetadata(this);
    ...
    public function get id() : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FdriverratePK
    {
        return _internal_id;
    }
    ...
    public function set id(value:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FdriverratePK) : void
    {
        var oldValue:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FdriverratePK = _internal_id;
        if (oldValue !== value)
        {
            _internal_id = value;
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FdriverrateEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FdriverrateEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FdriverrateEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
