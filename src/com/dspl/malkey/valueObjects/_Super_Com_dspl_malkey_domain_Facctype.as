 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Facctype.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Facctype extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Facctype") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Facctype", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FacctypeEntityMetadata;
    ...
    public function _Super_Com_dspl_malkey_domain_Facctype()
    {
        _model = new _Com_dspl_malkey_domain_FacctypeEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FacctypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FacctypeEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FacctypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
