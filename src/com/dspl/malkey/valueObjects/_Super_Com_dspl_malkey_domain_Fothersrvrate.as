 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fothersrvrate.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fothersrvrate extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fothersrvrate") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fothersrvrate", cz);
            }
        }
        catch (e:Error)
        {
    ...
    {
        com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FothersrvratePK.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FothersrvrateEntityMetadata;
    ...
    public function _Super_Com_dspl_malkey_domain_Fothersrvrate()
    {
    ...
    public function get id() : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FothersrvratePK
    {
        return _internal_id;
    }
    ...
    public function set id(value:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FothersrvratePK) : void
    {
        var oldValue:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FothersrvratePK = _internal_id;
        if (oldValue !== value)
        {
            _internal_id = value;
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FothersrvrateEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FothersrvrateEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FothersrvrateEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
