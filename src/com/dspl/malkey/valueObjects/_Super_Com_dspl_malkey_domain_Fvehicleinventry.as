 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fvehicleinventry.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fvehicleinventry extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fvehicleinventry") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fvehicleinventry", cz);
            }
        }
        catch (e:Error)
        {
    ...
    {
        com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FvehicleinventryPK.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FvehicleinventryEntityMetadata;

    /**
     * properties
     */
    private var _internal_id : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FvehicleinventryPK;
    ...
    public function _Super_Com_dspl_malkey_domain_Fvehicleinventry()
    {
        _model = new _Com_dspl_malkey_domain_FvehicleinventryEntityMetadata(this);
    ...
    public function get id() : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FvehicleinventryPK
    {
        return _internal_id;
    }
    ...
    public function set id(value:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FvehicleinventryPK) : void
    {
        var oldValue:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FvehicleinventryPK = _internal_id;
        if (oldValue !== value)
        {
            _internal_id = value;
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FvehicleinventryEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FvehicleinventryEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FvehicleinventryEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfId : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FvehicleinventryPK;

    model_internal function _doValidationForId(valueIn:Object):Array
    {
        var value : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FvehicleinventryPK = valueIn as com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FvehicleinventryPK;
