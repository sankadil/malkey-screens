 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fresaccs.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fresaccs extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fresaccs") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fresaccs", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FresaccsEntityMetadata;
    ...
    private var _internal_id : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresaccsPK;
    ...
    public function _Super_Com_dspl_malkey_domain_Fresaccs()
    {
        _model = new _Com_dspl_malkey_domain_FresaccsEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "fresaccrate", model_internal::setterListenerFresaccrate));
    ...
    [Bindable(event="propertyChange")]
    public function get fresaccrate() : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fresaccrate
    {
        return _internal_fresaccrate;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get id() : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresaccsPK
    {
        return _internal_id;
    }
    ...
    public function set fresaccrate(value:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fresaccrate) : void
    {
        var oldValue:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fresaccrate = _internal_fresaccrate;
        if (oldValue !== value)
        {
            _internal_fresaccrate = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "fresaccrate", oldValue, _internal_fresaccrate));
        }
    }
    ...
    public function set id(value:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresaccsPK) : void
    {
        var oldValue:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresaccsPK = _internal_id;
        if (oldValue !== value)
        {
            _internal_id = value;
    ...
    model_internal function setterListenerFresaccrate(value:flash.events.Event):void
    {
        _model.invalidateDependentOnFresaccrate();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.fresaccrateIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_fresaccrateValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FresaccsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FresaccsEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FresaccsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfFresaccrate : Array = null;
    model_internal var _doValidationLastValOfFresaccrate : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fresaccrate;

    model_internal function _doValidationForFresaccrate(valueIn:Object):Array
    {
        var value : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fresaccrate = valueIn as com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fresaccrate;

        if (model_internal::_doValidationCacheOfFresaccrate != null && model_internal::_doValidationLastValOfFresaccrate == value)
           return model_internal::_doValidationCacheOfFresaccrate ;

        _model.model_internal::_fresaccrateIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isFresaccrateAvailable && _internal_fresaccrate == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "fresaccrate is required"));
        }

        model_internal::_doValidationCacheOfFresaccrate = validationFailures;
        model_internal::_doValidationLastValOfFresaccrate = value;
    ...
    model_internal var _doValidationLastValOfId : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresaccsPK;

    model_internal function _doValidationForId(valueIn:Object):Array
    {
        var value : com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresaccsPK = valueIn as com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FresaccsPK;
