 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fvehiclemake.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fvehiclemake extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fvehiclemake") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fvehiclemake", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FvehiclemakeEntityMetadata;
    ...
    public function _Super_Com_dspl_malkey_domain_Fvehiclemake()
    {
        _model = new _Com_dspl_malkey_domain_FvehiclemakeEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FvehiclemakeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FvehiclemakeEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FvehiclemakeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
