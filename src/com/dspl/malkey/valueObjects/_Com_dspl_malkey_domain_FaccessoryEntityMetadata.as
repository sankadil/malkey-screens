...
[ExcludeClass]
internal class _Com_dspl_malkey_domain_FaccessoryEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("model", "dwarrantend", "accid", "addmach", "adddate", "adduser", "image", "qty", "accimagedata", "locationid", "dpurchase", "description", "value", "acctypeid", "make", "recordid");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("model", "dwarrantend", "accid", "addmach", "adddate", "adduser", "image", "qty", "accimagedata", "locationid", "dpurchase", "description", "value", "acctypeid", "make", "recordid");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("model", "dwarrantend", "accid", "addmach", "adddate", "adduser", "image", "qty", "accimagedata", "locationid", "dpurchase", "description", "value", "acctypeid", "make", "recordid");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "Com_dspl_malkey_domain_Faccessory";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();


    model_internal var _instance:_Super_Com_dspl_malkey_domain_Faccessory;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _Com_dspl_malkey_domain_FaccessoryEntityMetadata(value : _Super_Com_dspl_malkey_domain_Faccessory)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["dwarrantend"] = new Array();
            ...
            model_internal::dependentsOnMap["accimagedata"] = new Array();
            ...
            model_internal::dependentsOnMap["acctypeid"] = new Array();
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity Com_dspl_malkey_domain_Faccessory");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity Com_dspl_malkey_domain_Faccessory");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity Com_dspl_malkey_domain_Faccessory");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isDwarrantendAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isAccimagedataAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isAcctypeidAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get dwarrantendStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get accimagedataStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get acctypeidStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
