 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fvehicletype.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fvehicletype extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fvehicletype") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fvehicletype", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FvehicletypeEntityMetadata;

    /**
     * properties
     */
    private var _internal_vehicletypeimagedata : ByteArray;
    ...
    public function _Super_Com_dspl_malkey_domain_Fvehicletype()
    {
        _model = new _Com_dspl_malkey_domain_FvehicletypeEntityMetadata(this);
    ...
    public function get vehicletypeimagedata() : ByteArray
    {
        return _internal_vehicletypeimagedata;
    }
    ...
    public function set vehicletypeimagedata(value:ByteArray) : void
    {
        var oldValue:ByteArray = _internal_vehicletypeimagedata;
        if (oldValue !== value)
        {
            _internal_vehicletypeimagedata = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "vehicletypeimagedata", oldValue, _internal_vehicletypeimagedata));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FvehicletypeEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FvehicletypeEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FvehicletypeEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
