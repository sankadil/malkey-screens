 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fresvehicledamage.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fresvehicledamage extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fresvehicledamage") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fresvehicledamage", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FresvehicledamageEntityMetadata;
    ...
    private var _internal_ioflag : int;
    ...
    public function _Super_Com_dspl_malkey_domain_Fresvehicledamage()
    {
        _model = new _Com_dspl_malkey_domain_FresvehicledamageEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get ioflag() : int
    {
        return _internal_ioflag;
    }
    ...
    public function set ioflag(value:int) : void
    {
        var oldValue:int = _internal_ioflag;
        if (oldValue !== value)
        {
            _internal_ioflag = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "ioflag", oldValue, _internal_ioflag));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FresvehicledamageEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FresvehicledamageEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FresvehicledamageEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
