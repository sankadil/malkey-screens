 ...
 * of this value object you may modify the generated sub-class of this class - Com_dspl_malkey_domain_Fsmssent.as.
 */
...
[ExcludeClass]
public class _Super_Com_dspl_malkey_domain_Fsmssent extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.dspl.malkey.domain.Fsmssent") == null)
            {
                flash.net.registerClassAlias("com.dspl.malkey.domain.Fsmssent", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _Com_dspl_malkey_domain_FsmssentEntityMetadata;

    /**
     * properties
     */
    private var _internal_remindertype : String;
    private var _internal_message : String;
    private var _internal_tsynched : String;
    private var _internal_schtosend : int;
    ...
    private var _internal_schdate : Date;
    private var _internal_sentstatus : String;
    private var _internal_tomobile : String;
    ...
    public function _Super_Com_dspl_malkey_domain_Fsmssent()
    {
        _model = new _Com_dspl_malkey_domain_FsmssentEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get schtosend() : int
    {
        return _internal_schtosend;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get schdate() : Date
    {
        return _internal_schdate;
    }

    [Bindable(event="propertyChange")]
    public function get sentstatus() : String
    {
        return _internal_sentstatus;
    }

    [Bindable(event="propertyChange")]
    public function get tomobile() : String
    {
        return _internal_tomobile;
    }
    ...
    public function set remindertype(value:String) : void
    {
        var oldValue:String = _internal_remindertype;
        if (oldValue !== value)
        {
            _internal_remindertype = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "remindertype", oldValue, _internal_remindertype));
        }
    }
    ...
    public function set schtosend(value:int) : void
    {
        var oldValue:int = _internal_schtosend;
        if (oldValue !== value)
        {
            _internal_schtosend = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "schtosend", oldValue, _internal_schtosend));
        }
    }
    ...
    public function set schdate(value:Date) : void
    {
        var oldValue:Date = _internal_schdate;
        if (oldValue !== value)
        {
            _internal_schdate = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "schdate", oldValue, _internal_schdate));
        }
    }

    public function set sentstatus(value:String) : void
    {
        var oldValue:String = _internal_sentstatus;
        if (oldValue !== value)
        {
    ...
    public function set tomobile(value:String) : void
    {
        var oldValue:String = _internal_tomobile;
        if (oldValue !== value)
        {
            _internal_tomobile = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "tomobile", oldValue, _internal_tomobile));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Com_dspl_malkey_domain_FsmssentEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Com_dspl_malkey_domain_FsmssentEntityMetadata) : void
    {
        var oldValue : _Com_dspl_malkey_domain_FsmssentEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
