 ...
 * of this service wrapper you may modify the generated sub-class of this class - FtaxhedSRV.as.
 */
...
import com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxhed;
...
[ExcludeClass]
internal class _Super_FtaxhedSRV extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_FtaxhedSRV()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxhed._initRemoteClassAlias();
        ...
        operation = new mx.rpc.remoting.Operation(null, "deleterec");
         operation.resultType = Boolean;
        operations["deleterec"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "findById");
         operation.resultType = com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxhed;
        operations["findById"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "edit");
         operation.resultType = Boolean;
        operations["edit"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "list");
         operation.resultElementType = com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxhed;
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function update(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxhed) : mx.rpc.AsyncToken
    {
    ...
    /**
      * This method is a generated wrapper used to call the 'deleterec' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function deleterec(arg0:String) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("deleterec");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send(arg0) ;
    ...
    /**
      * This method is a generated wrapper used to call the 'edit' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function edit(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxhed, arg1:ArrayCollection) : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("edit");
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function create(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxhed) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function insert(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxhed, arg1:ArrayCollection) : mx.rpc.AsyncToken
    {
