 ...
 * of this service wrapper you may modify the generated sub-class of this class - FtaxdetSRV.as.
 */
...
import com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxdet;
...
[ExcludeClass]
internal class _Super_FtaxdetSRV extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_FtaxdetSRV()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxdet._initRemoteClassAlias();
        ...
        operation = new mx.rpc.remoting.Operation(null, "listAll");
         operation.resultElementType = com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxdet;
        ...
        operation = new mx.rpc.remoting.Operation(null, "findById");
         operation.resultType = com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxdet;
    ...
    /**
      ...
      */
    public function create(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxdet) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function findById(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FtaxdetPK) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function removeById(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FtaxdetPK) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function update(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Ftaxdet) : mx.rpc.AsyncToken
    {
