 ...
 * of this service wrapper you may modify the generated sub-class of this class - FreschkoutdamageSRV.as.
 */
...
import com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Freschkoutdamage;
...
[ExcludeClass]
internal class _Super_FreschkoutdamageSRV extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_FreschkoutdamageSRV()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Freschkoutdamage._initRemoteClassAlias();
        ...
        operation = new mx.rpc.remoting.Operation(null, "ListAll");
         operation.resultElementType = com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Freschkoutdamage;
        operations["ListAll"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "count");
         operation.resultType = int;
        operations["count"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "findByID");
         operation.resultType = com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Freschkoutdamage;
        ...
        destination = "freschkoutdamageSRV";
    ...
    /**
      ...
      */
    public function removeByID(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FreschkoutdamagePK) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function findByID(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_FreschkoutdamagePK) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function udpate(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Freschkoutdamage) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function create(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Freschkoutdamage) : mx.rpc.AsyncToken
    {
