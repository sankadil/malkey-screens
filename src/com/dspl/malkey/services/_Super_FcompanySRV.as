 ...
 * of this service wrapper you may modify the generated sub-class of this class - FcompanySRV.as.
 */
...
import com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fcompany;
...
[ExcludeClass]
internal class _Super_FcompanySRV extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_FcompanySRV()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fcompany._initRemoteClassAlias();
        ...
        operation = new mx.rpc.remoting.Operation(null, "ListAll");
         operation.resultElementType = com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fcompany;
        operations["ListAll"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "count");
         operation.resultType = int;
        operations["count"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "findByID");
         operation.resultType = com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fcompany;
        operations["findByID"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "listCompanies");
         operation.resultElementType = com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fcompany;
        operations["listCompanies"] = operation;
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function update(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fcompany, arg1:ArrayCollection) : mx.rpc.AsyncToken
    {
    ...
    /**
      * This method is a generated wrapper used to call the 'listCompanies' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function listCompanies() : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("listCompanies");
        var _internal_token:mx.rpc.AsyncToken = _internal_operation.send() ;
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function create(arg0:com.dspl.malkey.valueObjects.Com_dspl_malkey_domain_Fcompany, arg1:ArrayCollection) : mx.rpc.AsyncToken
    {
